...
<Note>
  ...
  when an observed input or overlapping write changed.
</Note>
...
Explicit garbage collection preserves blobs referenced by both valid disk states and live scene scopes, including undo history.
