...
Stages return semantic patches. The application commits each result, synchronizes the canvas, and records each commit as its own named state in the history panel.
