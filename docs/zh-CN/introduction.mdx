...
<Card title="翻译第一个项目" href="/zh-CN/getting-started/first-project">
  从安装开始，用最短路径完成检查并导出结果。
</Card>

<Card title="安装 Koharu" href="/zh-CN/getting-started/install">
  下载并安装 Koharu 桌面应用。
</Card>
...
<CardGroup cols={2}>
  <Card title="第一个项目" href="/zh-CN/getting-started/first-project">
    从安装开始，用最短路径完成检查并导出结果。

    - [安装 Koharu](/zh-CN/getting-started/install)
    - [翻译第一个项目](/zh-CN/getting-started/first-project)
    - [选择运行时与模型](/zh-CN/getting-started/runtimes-and-hardware)
  </Card>
  <Card title="编辑页面" href="/zh-CN/workflow/review-text">
    从需要调整的部分继续工作。
  ...
  <Card title="模型" href="/zh-CN/models/vision-and-inpainting">
  ...
  <Card title="开发" href="/zh-CN/development/setup">
